...
class ISteamRepository(ABC):
    ...
    @abstractmethod
    async def search_game(self,session,page:int=1,limit:int=10,name = None,category = None,ganre = None,discount = None,publisher = None,to_price = None,out_price = None) -> Optional[List[Game]]:
        pass
